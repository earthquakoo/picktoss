...
public class DocumentCreateController {
    ...
    public ResponseEntity<CreateDocumentResponse> createDocument(
        ...
        Long documentId = documentCreateService.createDocument(request.getEmoji(), request.getCategoryId(), request.getFile(), request.getDocumentType(), request.getQuizType(), request.getIsPublic(), star, memberId);
